...
import { ArrowLeft, TestTube, Loader2 } from 'lucide-react';
...
export default function AiTestCaseGeneratorPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
        ...
        console.error("Error generating or saving test cases:", error);
        toast({
            variant: 'destructive',
            title: 'Generation Failed',
            description: 'There was a problem generating or saving test cases.',
        });
    } finally {
        setIsGenerating(false);
    }
    ...
    <div className="grid gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Based on a scenario, screenshot, or Figma link, the AI will create detailed test cases for your review.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button type="submit" disabled={isGenerating || areProjectsLoading} className="w-full">
                ...
                {isGenerating ? 'Generating...' : 'Generate and Review Test Cases'}
              </Button>
            </form>
          </Form>
        </CardContent>
      ...
      {isGenerating && (
        <Alert>
            ...
            <AlertDescription>
                Please wait while the test cases are being generated. This might take a moment.
            </AlertDescription>
        </Alert>
      )}
    </div>
